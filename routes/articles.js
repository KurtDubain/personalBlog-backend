...
router.get('/ByTag/PageCtrl',articlesController.getArticlesByTag)//获取指定标签下的文章信息
router.get('/search/Page',articlesController.getSearchedArticles)//获取指定搜索关键字的文章信息
